<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="WebApplication4.ForgotPassword" %>
    ...
    <div class="main">
         <form id="form2" runat="server" class="login">
            ...
            <div class="login-group">
                <asp:Label ID="Label1" runat="server" Text="UserName/Email" CssClass="label"></asp:Label>
                <asp:TextBox ID="UserName" runat="server" CssClass="inp"></asp:TextBox>
            </div>
            <asp:Label ID="Forgot_Error" runat="server" CssClass="error" Text=""></asp:Label>
            <br />
            <br />
